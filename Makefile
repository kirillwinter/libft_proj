...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/11/23 18:33:55 by wballaba          #+#    #+#              #
#    Updated: 2018/11/23 18:33:57 by wballaba         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	...
	ft_close_file.c ft_read_file.c ft_sqrt.c
...
$(NAME):
	gcc -c -Wall -Wextra -Werror -g $(SRCS) -I $(INCLUDES)
	ar rc $(NAME) $(OBJ)
	ranlib $(NAME)
